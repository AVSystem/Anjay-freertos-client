...
/* Exported types ------------------------------------------------------------*/
/* USER CODE BEGIN ET */
typedef SensorAxes_t bsp_axes_t;
/* USER CODE END ET */
...
/* Exported macro ------------------------------------------------------------*/
/* USER CODE BEGIN EM */
#define BSP_MODEL_NUMBER "STM32L496AG"

#define BSP_BUTTON      JOY_SEL_Pin
#define BSP_BUTTON_PORT JOY_SEL_GPIO_Port

#define BSP_HEARTBEAT_LED      HEARTBEAT_LED_Pin
#define BSP_HEARTBEAT_LED_PORT HEARTBEAT_LED_GPIO_Port

#define BSP_JOYSTICK_PRESENT

#define BSP_AXIS_X AXIS_X
#define BSP_AXIS_Y AXIS_Y
#define BSP_AXIS_Z AXIS_Z
/* USER CODE END EM */
