...
#define SFU_PROTECT_FWALL_CODE_SIZE         ((uint32_t) SFU_SENG_ROM_SIZE)       /*!< Firewall protection CODE area
                                                                                      SIZE*/
#define SFU_PROTECT_FWALL_NVDATA_ADDR_START (SLOT_ACTIVE_1_HEADER)               /*!< Firewall protection NVDATA area
                                                                                           area START address*/
...
/**
  ...
  */
/**
  * Region definition : from 0x0800 0000 ==> 0x080F FFFF
...
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SIZE   MPU_REGION_SIZE_1MB
...
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SREG   0x00U                        /*!< 1 Mbytes */
