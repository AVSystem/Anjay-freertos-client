...
/**
  ...
  */
#define SFU_STATUS_LED (BSP_LED_GREEN)            /*!< LED to be used to provide the SB_SFU status to the end-user */
...
*/
#define SFU_NB_MAX_ACTIVE_IMAGE 1U                        /*!< 2 active image managed */
#define SFU_NB_MAX_DWL_AREA     1U                        /*!< 2 dwl area managed */
