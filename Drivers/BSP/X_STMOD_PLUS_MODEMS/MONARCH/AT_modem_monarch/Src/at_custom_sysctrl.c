...
/** @defgroup AT_CUSTOM_SEQUANS_MONARCH_SYSCTRL_Private_Macros AT_CUSTOM SEQUANS_MONARCH SYSCTRL Private Macros
  * @{
  */
...
/** @defgroup AT_CUSTOM_SEQUANS_MONARCH_SYSCTRL_Private_Functions_Prototypes
  *     AT_CUSTOM SEQUANS_MONARCH SYSCTRL Private Functions Prototypes
  * @{
  */
...
/**
  * @brief  Activate or deactivate RING interrupt
  * @param  set Indicates if interrupt is set or not
  * @retval sysctrl_status_t
  */
...
/** @defgroup AT_CUSTOM_SEQUANS_MONARCH_SYSCTRL_Private_Functions AT_CUSTOM SEQUANS_MONARCH SYSCTRL Private Functions
  * @{
  */
...
static sysctrl_status_t SysCtrl_MONARCH_setup(void)
{
...
#if (MODEM_UART_HWFLOWCTRL == UART_HWCONTROL_NONE)
  /* To avoid communication problem with Host and Modem when
   *  - modem is configured with HwFlowCtrl enabled
   *  - host is configured with HwFlowCtrl disabled
   * we force UART-RTS pin to Low level during init
   */
  ...
  HAL_GPIO_WritePin(MODEM_RTS_GPIO_PORT, MODEM_RTS_PIN, GPIO_PIN_RESET);
#endif /* (MODEM_UART_HWFLOWCTRL == UART_HWCONTROL_NONE) */
...
/**
  * @brief  Enable Modem UART for Low Power mode.
  * @retval none
  */
static void monarch_LP_enable_modem_uart(void)
{
