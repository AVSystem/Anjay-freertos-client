...
/**
  ******************************************************************************
  ...
  The list of Cellular Service Data Cache Entries is (summary):
    ...
    ------------------------------------
    DC_CELLULAR_INFO              contains informations returned by the modem
    DC_CELLULAR_DATA_INFO         contains the state of data transfert feature
    DC_CELLULAR_NIFMAN_INFO       contains NIFMAN informations
    DC_CELLULAR_SIM_INFO          contains SIM slot informations
    DC_CELLULAR_CONFIG            contains Cellular configuration parameters
    DC_CELLULAR_NFMC_INFO         contains NFMC informations
...
#define DC_SIM_SLOT_MODEM_SOCKET             0   /*!< Modem Socket SIM slot type   */
#define DC_SIM_SLOT_MODEM_EMBEDDED_SIM       1   /*!< Modem Embedded SIM slot type */
#define DC_SIM_SLOT_STM32_EMBEDDED_SIM       2   /*!< Modem Embedded SIM slot type (not yet available)*/
...
typedef enum
{
  ...
  DC_SIM_NOT_IMPLEMENTED      = 1,     /*!< Not impemented                    */
...
typedef enum
{
  DC_NO_NETWORK              = 0,     /*!< No avalaible Network               */
  DC_CELLULAR_SOCKET_MODEM   = 1,     /*!< Modem Socket network mode          */
  DC_CELLULAR_SOCKETS_LWIP   = 2      /*!< Modem Socket network mode          */
} dc_nifman_network_t;
...
typedef struct
{
  ...
  dc_cs_sim_status_t     sim_status[DC_SIM_SLOT_NB];  /*!< Status of avalaible SIM slots             */
} dc_sim_info_t;
...
/**
  ...
  *         allows to know if the cellular data transfert service is available or not
...
/**
  ...
  *         allows to know if the network data transfert service is available or not
...
/**
  ...
  *         The  target state available are: power off, sim ony and full feature.
