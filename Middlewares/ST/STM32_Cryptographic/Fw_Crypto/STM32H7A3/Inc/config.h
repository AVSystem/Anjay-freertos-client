...
typedef struct
{
  uint8_t X;                   /*!< Used to get the X parameter of the current STM32 crypto library version */
  uint8_t Y;                   /*!< Used to get the Y parameter of the current STM32 crypto library version */
  uint8_t Z;                   /*!< Used to get the Z parameter of the current STM32 crypto library version */
...
/** @defgroup CRYPTO_LIBRARY_VERSION
  ...
  * @{
  */
#define VERSION_X 3 /*!< The X parameter of the current STM32 crypto library version */
#define VERSION_Y 0 /*!< The Y parameter of the current STM32 crypto library version */
#define VERSION_Z 0 /*!< The Z parameter of the current STM32 crypto library version */
/**
